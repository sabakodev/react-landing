	...
	const directories = [
		{
			...
			contacts: [
				{
					name: 'Reyhan Fabiano',
					value: '+62 857-6061-6555',
					href: 'https://wa.me/6285760616555',
				},
				{
		...
		},
		{
			...
			contacts: [
				{
					name: 'Reyhan Fabiano',
					value: 'reyhan@sabako.id',
					href: 'mailto:reyhan@sabako.id',
				},
			]
		},
	]
			...
			<div className="relative place-items-center lg:max-w-5xl w-full mb-16">
				...
				<div className="mt-16 text-gray-300 leading-6">
					<div className="grid lg:grid-cols-2 w-full mb-32">
						<div className="lg:w-1/2">Jl. Bangka Raya No. 48, Mampang Prapatan 12720, Jakarta, Indonesia</div>
