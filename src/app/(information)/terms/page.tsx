			...
			<section className="py-20 border-b border-(--border)">
				<div className="mx-auto max-w-7xl px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
					<div className="space-y-6 text-(--text-muted) leading-relaxed">
						...
						<h2 className="text-2xl font-bold text-(--text)">2. Use of the Site</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">3. Intellectual Property</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">4. Services</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">5. User Submissions</h2>
						<p>
							Any information you submit through the Site (including contact forms, inquiries, or feedback) is subject to our <Link href="/privacy" className="text-(--brand) hover-underline">Privacy Policy</Link>. By submitting information, you grant us the right to use it for the purposes described in our Privacy Policy and to respond to your inquiries.
						</p>
					</div>

					<div className="space-y-6 text-(--text-muted) leading-relaxed">
						<h2 className="text-2xl font-bold text-(--text)">6. Disclaimer of Warranties</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">7. Limitation of Liability</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">8. Third-Party Links</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">9. Indemnification</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">11. Changes to These Terms</h2>
						<p>
						...
						<h2 className="text-2xl font-bold text-(--text)">12. Contact</h2>
						<p>
							If you have any questions about these Terms, please contact us at{' '}
							<a href="mailto:legal@sabako.id" className="text-(--brand) hover-underline">legal@sabako.id</a>.
						</p>
					</div>
				</div>
			</section>
