...
export default function AboutPage() {
	return (
		<article>
			...
			{/* Story */}
			<section className="py-20 border-b border-(--border)" aria-label="Our story">
				<div className="mx-auto max-w-7xl px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
					<div>
						<h2 className="text-2xl font-bold text-(--text) mb-6">Who we are</h2>
						<div className="space-y-4 text-(--text-muted) leading-relaxed">
							<p className="text-xs font-mono text-(--text-subtle)">Last Updated: 2026-02-20</p>
							<p>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">International Data Transfers</h3>
							<p>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">Business Transfers</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">GDPR/EEA/UK rights</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">California privacy rights (CCPA/CPRA)</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">How to excercise your rights</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">Children&apos;s Privacy</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">Data retention</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">Changes to this Privacy Policy</h3>
							...
							<h3 className="text-xl font-bold text-(--text) mb-2">Contact Us</h3>
					...
					<div className="space-y-4 text-(--text-muted) leading-relaxed">
						<h2 className="text-2xl font-bold text-(--text) mb-6">How we collect and use your information</h2>
						<p>
							We may collect:
						</p>
						<ul className="list-disc list-outside text-(--text)">
							<li>Full Name</li>
							<li>Email Address</li>
							<li>Phone Number</li>
							<li>Any information you submit via forms or communications (e.g., messages, inquiries)</li>
						</ul>
						<p className="border-l-2 border-(--brand) pl-4 text-(--text) font-medium">
						...
						<h3 id="cookies" className="text-xl font-bold text-(--text) mb-2">Analytics &amp; Cookies</h3>
						<p>We use two analytics systems with different consent requirements:</p>
						<div className="space-y-3 my-2">
							<div className="border border-(--border) p-4">
								<p className="text-sm font-bold text-(--text) mb-1">Cloudflare Web Analytics — Essential</p>
								<p className="text-xs text-(--text-muted) leading-relaxed">Cookieless, privacy-first RUM. No personal data or cross-site tracking. Legitimate interest basis. <strong>Always active.</strong></p>
							</div>
							<div className="border border-(--border) p-4">
								<p className="text-sm font-bold text-(--text) mb-1">Google Analytics 4 — Analytics (Consent Required)</p>
								<p className="text-xs text-(--text-muted) leading-relaxed">Tracks page views and events using cookies. Only loaded after consent. Legal basis: consent.</p>
							</div>
						</div>
						<p className="font-bold text-(--text) text-sm mt-4">Cookie Table</p>
						<div className="overflow-x-auto">
							<table className="w-full text-xs border-collapse border border-(--border)">
								<thead className="bg-(--bg-subtle)">
									<tr className="text-left">
										<th className="py-2 px-3 border border-(--border) font-mono text-(--text-subtle) uppercase">Name</th>
										<th className="py-2 px-3 border border-(--border) font-mono text-(--text-subtle) uppercase">Provider</th>
										<th className="py-2 px-3 border border-(--border) font-mono text-(--text-subtle) uppercase">Purpose</th>
										<th className="py-2 px-3 border border-(--border) font-mono text-(--text-subtle) uppercase">Expiry</th>
									</tr>
								</thead>
								<tbody>
									<tr><td className="py-2 px-3 border border-(--border) font-mono text-(--text)">_ga</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">Google Analytics 4</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">Distinguishes users</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">2 years</td></tr>
									<tr><td className="py-2 px-3 border border-(--border) font-mono text-(--text)">_ga_*</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">Google Analytics 4</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">Persists GA4 session state</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">2 years</td></tr>
									<tr><td className="py-2 px-3 border border-(--border) font-mono text-(--text)">sabako_consent</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">SABAKO</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">Stores analytics consent preference</td><td className="py-2 px-3 border border-(--border) text-(--text-muted)">localStorage</td></tr>
								</tbody>
							</table>
						</div>
						<p className="border-l-2 border-(--brand) pl-4 text-(--text) font-medium">Change your cookie preferences at any time using <strong>Cookie Settings</strong> in the footer.</p>
						<h3 className="text-xl font-bold text-(--text) mb-2">How your data would be processed</h3>
						...
						<h3 className="text-xl font-bold text-(--text) mb-2">Legal & Safety</h3>
						...
						<h3 className="text-xl font-bold text-(--text) mb-2">Third-party sites</h3>
			...
			{/* Values */}
			<section className="py-20 border-b border-(--border) bg-(--bg-subtle)" aria-labelledby="values-heading">
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<h2 id="values-heading" className="text-2xl font-bold text-(--text) mb-12">
						Key Points
					</h2>
